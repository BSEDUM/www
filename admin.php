...
<html>
	...
	<body>
		...
		$form->addText('path', 'cesta:')
				->setOption('description',Html::el('b')->setHtml('/home/pi/b7 Cesta pro umisteni souboru !!'))
				->setRequired('Zadejte cestu souboru');
		...
		$form->addText('dstdir', 'Cílový adresář:')
